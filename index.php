...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientCompany'] = "hsOj24bIkvOweWEjVoRR";
        $headers['auth']['clientSecret'] = "MzI1aHNPajI0Yklrdk93ZVdFalZvUlJjZTY2ZjZlNmY5ZGVmNTEwYWM0MGJhMmU2NWMyYWNkYTAxNDJmZmFl";
